...
Berdasarkan \textit{sequence diagram} yang telah dibuat pada \textbf{Bagian \ref{subsec:arsitektur-behavioural}}. Sistem \textit{service} akan dibagi menjadi beberapa domain. Pembagian domain berfungsi untuk memfokuskan implementasi serta memudahkan tahapan testing. Terdapat 6 domain yaitu \textit{company}, \textit{user}, \textit{devices}, \textit{groups}, \textit{deployment}, dan \textit{external services}. Masing masing domain akan memiliki diagram kelas yang menjelaskan rancangan implementasi
