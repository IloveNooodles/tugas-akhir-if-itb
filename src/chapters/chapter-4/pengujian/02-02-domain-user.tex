...
%   \item Mengisi \textit{field email} dengan nilai "kind-psa-with-cluster-pss"
%   \item Mengisi \textit{field password} dengan nilai "kind-psa-with-cluster-pss"
%   \item Mengisi \textit{field company\textunderscore id} dengan nilai "kind-psa-with-cluster-pss"
% \end{enumerate}
